...
7. חובה לחלוטין בסוף התשובה: בשורה האחרונה ממש של התשובה שלך, תחת הכותרת 'מיקומים למפה:', עליך להציג רשימה מופרדת בפסיקים של שמות המיקומים המדויקים שנבחרו (בין 3 ל-5 מיקומים). עבור מרכז וגוש דן השורה האחרונה חייבת להיות בדיוק כך: מיקומים למפה: פארק הירקון, מוזיאון ארץ ישראל, טיילת תל אביב, שוק הכרמל`
                    },
