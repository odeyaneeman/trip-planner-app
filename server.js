...
6. חוק בל יעבור למיקומים והתאמה קשיחה:
- אם המשתמש מבקש את אזור מרכז וגוש דן עם סגנון עירוני ותרבות, עליך חובה מוחלטת להחזיר תוכנית יום המבוססת בדיוק ורק על המיקומים הבאים: פארק הירקון, מוזיאון ארץ ישראל (רמת אביב), טיילת תל אביב, שוק הכרמל. אל תמציא שום מקום אחר!
- עבור בקשות אחרות, בחר מתוך הבנק הבא בלבד: אגמון החולה, ראש הנקרה, מצפה רמון.

7. חובה לחלוטין בסוף התשובה: בשורה האחרונה ממש של התשובה שלך, תחת הכותרת 'מיקומים למפה:', עליך להציג רשימה מופרדת בפסיקים של שמות המיקומים המדויקים שנבחרו (בין 3 ל-5 מיקומים). עבור מרכז וגוש דן השורה האחרונה חייבת להיות בדיוק כך: מיקומים למפה: פארק הירקון, מוזיאון ארץ ישראל (רמת אביב), טיילת תל אביב, שוק הכרמל`
                    },
