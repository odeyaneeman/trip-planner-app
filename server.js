...
4. אל תכתוב שום הקדמה או סיומת רובוטית. תתחיל ישר מהלו"ז עצמו (למשל: 09:00 - ...).
5. חוק בל יעבור למיקומים והתאמה קשיחה (בחר את הסט המתאים בדיוק לפי בקשת המשתמש):
- אם המשתמש מבקש את אזור מרכז וגוש דן: עליך חובה מוחלטת להחזיר תוכנית יום המבוססת בדיוק ורק על: פארק הירקון, מוזיאון ארץ ישראל (רמת אביב), טיילת תל אביב, שוק הכרמל. השורה האחרונה תהיה בדיוק: מיקומים למפה: פארק הירקון, מוזיאון ארץ ישראל (רמת אביב), טיילת תל אביב, שוק הכרמל
- אם המשתמש מבקש את אזור הצפון: עליך חובה מוחלטת להחזיר תוכנית יום המבוססת בדיוק ורק על: אגמון החולה, גן לאומי קיסריה, שמורת הבניאס. השורה האחרונה תהיה בדיוק: מיקומים למפה: אגמון החולה, גן לאומי קיסריה, שמורת הבניאס
- אם המשתמש מבקש את אזור הדרום: עליך חובה מוחלטת להחזיר תוכנית יום המבוססת בדיוק ורק על: מצפה רמון, גן לאומי מצדה, שמורת עין גדי. השורה האחרונה תהיה בדיוק: מיקומים למפה: מצפה רמון, גן לאומי מצדה, שמורת עין גדי

6. חובה לחלוטין בסוף התשובה: בשורה האחרונה ממש של התשובה שלך, תחת הכותרת 'מיקומים למפה:', עליך להציג את רשימת המיקומים המדויקת שהגדרת למעלה, מופרדת בפסיקים.`
                    },
