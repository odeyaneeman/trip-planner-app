...
- אגמון החולה (מתאים לצפון, טבע, רגוע)
- מבצר נמרוד (מתאים לצפון, היסטוריה, אתגרי)
- חורשת טל (מתאים לצפון, מים, משפחות)
- ראש הנקרה (מתאים לצפון, ים ומערות, רגוע)
- שמורת הבניאס (מתאים לצפון, מים, טבע)
- גן לאומי אפולוניה (מתאים למרכז, ים ועתיקות, נוף)
- נאות קדומים (מתאים למרכז, טבע, משפחות)
- טיילת חומות ירושלים (מתאים לירושלים/מרכז, עירוני, היסטוריה)
- מתחם התחנה הראשונה (מתאים לירושלים/מרכז, עירוני, בילוי ורוגע)
- עין עבדת (מתאים לדרום, מדבר, מסלול הליכה)
- מצפה רמון (מתאים לדרום, נוף ומכתש, תצפית, רוגע)
- גן לאומי מצדה (מתאים לדרום, היסטוריה, אתגרי, זריחה)
- שמורת עינות צוקים (מתאים לדרום/ים המלח, נוווה מדבר, מים וצל)
- פארק תמנע (מתאים לדרום, מדבר, אטרקציות)
