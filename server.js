...
- אם המשתמש מבקש את אזור מרכז וגוש דן: עליך חובה מוחלטת להחזיר תוכנית יום המבוססת בדיוק ורק על: פארק הירקון, מוזיאון ארץ ישראל (רמת אביב), טיילת תל אביב, שוק הכרמל. השורה האחרונה תהיה בדיוק: מיקומים למפה: פארק הירקון, מוזיאון ארץ ישראל, טיילת תל אביב, שוק הכרמל
- אם המשתמש מבקש את אזור הצפון: עליך חובה מוחלטת להחזיר תוכנית יום המבוססת בדיוק ורק על: אגמון החולה, גן לאומי חורשת טל, שמורת טבע תל דן. השורה האחרונה תהיה בדיוק: מיקומים למפה: אגמון החולה, גן לאומי חורשת טל, שמורת טבע תל דן
- אם המשתמש מבקש את אזור הדרום: עליך חובה מוחלטת להחזיר תוכנית יום המבוססת בדיוק ורק על: נחל בוקק, גן לאומי מצדה, שמורת עין גדי. השורה האחרונה תהיה בדיוק: מיקומים למפה: נחל בוקק, גן לאומי מצדה, שמורת עין גדי
